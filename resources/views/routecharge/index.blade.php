...
@section('page_heading', 'Route Charge')

@section('breadcrumb')
    <ol class="breadcrumb">
        <li><a href="{{url('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"></a>Charge</li>
        <li class="active">Route Charge</li>
    </ol>
@endsection
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="div-table">
                            <table id="table-rc" class="table table-striped table-bordered" style="width:100%"></table>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
//            Select, Nav Tabs
            ...
            invoice_num.change(function () {
                ...
                if(id === 'all'){
                    ...
                    $('a#download').attr('href', 'download-charge-rc/'+id);
                }
...
//                Summary
                ...
                $('.update-type').click(function () {
                    ...
                    $.ajax({
                        url: '{{url('charge-rc-summary-update-type')}}',
                        type: 'POST',
                        data: {
                            'id': id,
                            'type_old': m_type_old,
...
//                    Grand Total Flight
                ...
                function find_period(from_period, to_period){
                    $.ajax({
                        url: '{{url('charge-rc-summary-period')}}',
                        type: 'GET',
                        data: {
...
//                Service
                $('#m-service').keypress(function(e) {
                    if(e.which === 13) {
                        ...
                        $.ajax({
                            url: '{{url('charge-rc-pivot-service')}}',
                            type: 'POST',
                            data: {
                                'id': m_id,
                                'service': m_service,
...
//                Pivot Invoices
                $.ajax({
                    url : '{{url('charge-rc-pivot-invoices')}}',
                    type : 'GET',
                    data : {
                        'id' : id,
                        'fn_number' : fn_number,
                        ...
                        if(data.length > 0) {
                            ...
                            $('#correction').click(function () {
                                ...
                                if(remarks_correction === ""){
                                    ...
                                    $.ajax({
                                        url: '{{url('charge-rc-pivot-correction')}}',
                                        type: 'GET',
                                        data: {
                                            'id': piv_id,
                                        ...
                                        success: function (data) {
                                            for(var j=1 ; j<=total_piv_inv; j++){
                                                ...
                                                var id = $('#invoice-num').val();

                                                if(checkbox.is(':checked')){
                                                    $.ajax({
                                                        url: '{{url('charge-rc-pivot-inv-update')}}',
                                                        type: 'GET',
                                                        data: {
                                                            'id': id,
                                                            'inv_id': inv_id,
                            ...
                            $('.piv-inv-fn').click(function () {
                                ...
                                tr.find('#fn-edit').keypress(function(e) {
                                    ...
                                    if(e.which === 13) {
                                        ...
                                        $.ajax({
                                            url : '{{url('charge-rc-pivot-inv-fn')}}',
                                            type : 'GET',
                                            data : {
                            ...
                            $('.piv-inv-service').click(function () {
                                ...
                                tr.find('#service-edit').keypress(function(e) {
                                    ...
                                    if(e.which === 13) {
                                        ...
                                        $.ajax({
                                            url : '{{url('charge-rc-pivot-inv-service')}}',
                                            type : 'GET',
                                            data : {
                                                'id' : id,
                                                'service' : service
...
//                Pivot Details
                $.ajax({
                    url : '{{url('charge-rc-pivot-details')}}',
                    type : 'GET',
                    data : {
                        'id' : id,
                        'fn_number' : fn_number,
                    ...
                    success: function(data){
                        if(data.length > 0) {
                            ...
                            for(var i=0;i<data.length;i++){
                                ...
                                table_content+='<td>'+data[i].ac_registration+'</td>' +
                                    '<td>'+dep_dt+'</td>' +
                                    '<td>'+arr_dt+'</td>' +
                                    '<td>'+time_out+'</td>';
                                ...
                                if(data[i].flight_check_rc === "unbilled"){
