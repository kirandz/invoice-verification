                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="div-table" hidden>
                            <table id="table-rc" class="table table-striped table-bordered" style="width:100%;display: block;overflow-x: auto;"></table>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
        ...
        $(document).ready(function() {
            ...
            from_period.change(function () {
                if(to_period.val() !== ''){
                    ...
                    $('a#download').attr('href', 'download-unbilled-rc/'+period);
